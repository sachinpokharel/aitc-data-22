...
const ServiceCommonBanner = ({
  ...
  return (
    <div className={cn('flex flex-col gap-10 p-5', isColumn ? ' items-center' : ' ', className)}>
      <div className='flex flex-col gap-2'>
        ...
        <CommonTitleH1
          title={title}
          className={isColumn ? 'text-center' : 'max-w-5xl text-center lg:text-left'}
      ...
      <div className='flex flex-col gap-6'>
        <CommonParargraph
          text={description}
          className={isColumn ? 'text-center' : 'max-w-4xl text-center lg:text-left'}
