...
const Banner = async () => {
  const data = await fetchData<BannerSection>('/services/software-development/hero-section');
  return (
    <CommonAnimation className='banner common-padding flex flex-col items-center justify-between gap-20 bg-lightShad2 py-20 lg:flex-row'>
      <ServiceCommonBanner
        title={data?.title}
      ...
      <span>
        ...
        >
          ...
          <defs>
            ...
            <image id='image0_7381_130327' width='1080' height='2048' xlinkHref={data?.bgImage} />
          </defs>
        </svg>
      </span>
    </CommonAnimation>
