...
import {
  ...
  weHelpWithTabs,
  whyCards,
} from '@/data/location/software-development-company-dubai-data';

export const metadata: Metadata = {
  title: 'Software Development Company for Dubai & UAE Businesses | AITC International',
  description:
    'AITC International is a software development company serving Dubai and UAE startups and businesses. Fixed-price delivery, 9+ hours GST overlap, UAE PDPL compliance experience, and 65% cost savings vs local Dubai agency rates.',
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/software-development-company-dubai`,
  },
  openGraph: {
    title: 'Software Development Company for Dubai & UAE Businesses | AITC International',
    description:
      'AITC International is a software development company serving Dubai and UAE startups and businesses. Fixed-price delivery, 9+ hours GST overlap, UAE PDPL compliance experience, and 65% cost savings vs local Dubai agency rates.',
    url: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/software-development-company-dubai`,
    type: 'website',
    siteName: 'AITC International',
  },
};

export default function SoftwareDevelopmentDubaiPage() {
  return (
    <>
      ...
      <CardGrid
        badge='Why Dubai businesses choose AITC'
        heading='Engineering quality without the Dubai agency price tag.'
        description='Dubai and UAE businesses choose AITC because we solve the three problems that kill most offshore relationships: timezone gaps, compliance risk, and unpredictable delivery.'
        cards={whyCards}
        bg='white'
      />

      {/* What we build for Dubai clients */}
      <section className='bg-gray-50'>
        <div className='common-padding mx-auto max-w-7xl py-16 md:py-20'>
          <div className='mb-10'>
            ...
            <h2 className='mt-2 text-2xl font-bold sm:text-3xl'>Full-service software development for Dubai & UAE businesses</h2>
            <p className='mt-2 max-w-xl text-base text-gray-500'>
              From a focused MVP to a fully staffed product squad — we cover every stage of software development for UAE clients on your Gulf Standard Time hours.
            </p>
          </div>
      ...
      <ComparisonTable
        ...
        heading='AITC vs Dubai Agency vs Freelancer'
        subheading='Why Dubai businesses choose AITC over the alternatives.'
        rows={comparisonRows}
        col1Label='AITC'
        col2Label='Dubai Agency'
      ...
      <Technologies
        heading='Every stack your UAE product needs'
        subheading="React, Next.js, Node.js, Python, Flutter, AWS, and more. With 200+ engineers, we cover whatever stack your Dubai product runs on."
      />
      ...
      <PostReviewsCTA
        badge='Software development for Dubai & UAE clients'
      ...
      <WeHelpWithService
        ...
        description='From a single hired developer to a full dedicated squad, AITC covers every model of working with Nepal-based engineering talent for Dubai and UAE businesses.'
        theme='light'
        tabs={weHelpWithTabs}
      />
      ...
      <IndustrySectors
        ...
        subheading='We have shipped production software for UAE businesses across fintech, real estate, hospitality, and more.'
      ...
      <BottomCTAForm
        ...
        form={{
          preselectedService: 'Software Development Dubai',
          formName: 'bofu-software-dev-dubai',
