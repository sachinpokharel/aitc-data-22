...
import {
  ...
  weHelpWithTabs,
  whyCards,
} from '@/data/location/offshore-software-development-company-nepal-data';

export const metadata: Metadata = {
  title: 'Offshore Software Development Company in Nepal | AITC International',
  description:
    'AITC is an offshore software development company based in Kathmandu, Nepal. Fixed-price delivery, timezone overlap with the US, UK, Australia, Europe, and the Middle East, and 70% cost savings vs US or UK agency rates.',
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/offshore-software-development-company-nepal`,
  },
  openGraph: {
    title: 'Offshore Software Development Company in Nepal | AITC International',
    description:
      'AITC is an offshore software development company based in Kathmandu, Nepal. Fixed-price delivery, timezone overlap with the US, UK, Australia, Europe, and the Middle East, and 70% cost savings vs US or UK agency rates.',
    url: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/offshore-software-development-company-nepal`,
    type: 'website',
    siteName: 'AITC International',
  },
};

export default function OffshoreNepalPage() {
  return (
    <>
      ...
      <CardGrid
        badge='Why businesses worldwide choose AITC'
        heading='Offshore engineering quality — without the offshore headaches.'
        description="Clients across the US, UK, Australia, Europe, and the Middle East choose AITC because we solve the three problems that kill most offshore relationships: timezone gaps, communication friction, and unpredictable delivery."
        cards={whyCards}
        bg='white'
      />
      ...
      <section className='bg-gray-50'>
        <div className='common-padding mx-auto max-w-7xl py-16 md:py-20'>
          <div className='mb-10'>
            ...
            <h2 className='mt-2 text-2xl font-bold sm:text-3xl'>Full-service offshore software development from Nepal</h2>
            <p className='mt-2 max-w-xl text-base text-gray-500'>
              From a focused MVP to a fully managed offshore squad — we cover every stage of software development, aligned to your market hours from Kathmandu.
            </p>
          </div>
      ...
      <ComparisonTable
        ...
        heading='AITC Nepal vs India Offshore vs Eastern Europe'
        subheading='Why global businesses choose Nepal over the alternatives.'
        rows={comparisonRows}
        col1Label='AITC Nepal'
        col2Label='India Offshore'
        col3Label='Eastern Europe'
        bg='light'
      />
      ...
      <Technologies
        heading='Every stack your offshore product needs'
        subheading="React, Next.js, Node.js, Python, Flutter, AWS, and more. With 200+ engineers in Kathmandu, we cover whatever stack your product already runs on."
      />
      ...
      <PostReviewsCTA
        badge='Offshore software development from Nepal'
      ...
      <WeHelpWithService
        ...
        description='From a single offshore developer to a full dedicated squad, AITC covers every model of working with Nepal-based engineering talent — for any market.'
        theme='light'
        tabs={weHelpWithTabs}
      />
      ...
      <IndustrySectors
        ...
        subheading='We have shipped production software for clients worldwide across healthcare, fintech, real estate, and more — from our Kathmandu base.'
        sectors={industrySectors}
        bg='white'
      />

      <BottomCTAForm
        badge='Ready to build offshore?'
        ...
        form={{
          preselectedService: 'Offshore Software Development Nepal',
          formName: 'bofu-offshore-software-nepal',
