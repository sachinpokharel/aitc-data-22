...
import {
  ...
  weHelpWithTabs,
  whyCards,
} from '@/data/location/offshore-development-team-nepal-for-europe-data';
import { type Metadata } from 'next';
import Link from 'next/link';

export const metadata: Metadata = {
  title: 'Offshore Development Team Nepal for Europe | AITC',
  description:
    'Build your offshore development team in Nepal for your European business. 5+ hours CET overlap, English-fluent engineers, 70% cost savings vs London/Berlin rates.',
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}locations/offshore-development-team-nepal-for-europe`,
  },
  openGraph: {
    title: 'Offshore Development Team Nepal for Europe | AITC',
    description:
      'Build your offshore development team in Nepal for your European business. 5+ hours CET overlap, English-fluent engineers, 70% cost savings vs London/Berlin rates.',
    url: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}locations/offshore-development-team-nepal-for-europe`,
    type: 'website',
    siteName: 'AITC International',
  },
};

export default function OffshoreEuropePage() {
  return (
    <>
        ...
        <div className='common-padding mx-auto max-w-7xl py-16 md:py-20'>
          <div className='mb-10 flex flex-col items-start gap-4 md:flex-row md:items-end md:justify-between'>
            <div>
              ...
              <p className='mt-2 max-w-xl text-base text-white/70'>
                Our Nepal teams shift their workday to align with European hours — giving you 5+ hours of real-time
                overlap for standups, reviews, and collaboration.
              </p>
            </div>
            <Link
          ...
          <div className='grid grid-cols-1 gap-4 sm:grid-cols-3'>
            <div className='rounded-xl bg-white/10 p-6'>
              ...
              <p className='mt-2 text-4xl font-black'>1:15 PM</p>
            ...
            <div className='rounded-xl bg-primary p-6'>
              <p className='text-xs font-bold uppercase tracking-widest text-white/70'>Central Europe</p>
              <p className='mt-2 text-4xl font-black'>9:00 AM</p>
              <p className='mt-1 text-sm text-white/80'>CET (UTC+1)</p>
              <p className='mt-3 text-sm text-white/90'>Full morning overlap for your Berlin / Amsterdam team</p>
            </div>

            <div className='rounded-xl bg-white/10 p-6'>
              <p className='text-xs font-bold uppercase tracking-widest text-primary'>UK & Ireland</p>
              <p className='mt-2 text-4xl font-black'>8:00 AM</p>
              <p className='mt-1 text-sm text-white/60'>GMT (UTC+0)</p>
              <p className='mt-3 text-sm text-white/70'>Full morning overlap for your London / Dublin team</p>
            </div>
          </div>

          <div className='mt-6 flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-6 py-4'>
            <span className='flex size-8 shrink-0 items-center justify-center rounded-full bg-primary text-sm font-black text-white'>5+</span>
      ...
      <ProcessSteps
        badge='The process'
        heading='From requirements to your first CET standup in 4 steps'
        steps={processSteps}
        bg='light'
      ...
      <Technologies
        heading='Every stack your European team relies on'
      ...
      <PostReviewsCTA
        badge='Offshore Team for Europe'
        heading='Ready to Build Your Offshore Team?'
        description="Tell us your requirements and we'll have matched profiles in your inbox within 24 hours — engineers already assessed for European timezone flexibility."
      ...
      <WeHelpWithService
        ...
        description='From a single offshore developer to a full dedicated squad, our Nepal-based teams cover every stage of the software lifecycle for European businesses.'
        theme='light'
        tabs={weHelpWithTabs}
      />
      ...
      <IndustrySectors
        ...
        subheading='Our Nepal-based teams have shipped software across healthcare, fintech, real estate, and more for European businesses.'
      ...
      <BottomCTAForm
        ...
        heading='Your offshore team could be on CET standups in 2 weeks'
        ...
        form={{
          preselectedService: 'Offshore Development Team Europe',
          formName: 'bofu-offshore-europe',
          heading: 'Get matched profiles in 24 hours',
          subheading:
            "Tell us what you need and we'll respond with engineers already assessed for European timezone flexibility.",
