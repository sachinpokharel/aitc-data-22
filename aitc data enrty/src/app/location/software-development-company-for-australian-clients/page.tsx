...
import {
  ...
  weHelpWithTabs,
  whyCards,
} from '@/data/location/software-development-company-for-australian-clients-data';

export const metadata: Metadata = {
  title: 'Software Development Company for Australian Clients | AITC International',
  description:
    'AITC International is a software development company serving Australian startups and businesses. Fixed-price delivery, 6+ hours AEST overlap, Australian Privacy Act compliance, and 70% cost savings vs Sydney/Melbourne rates.',
  alternates: {
    canonical: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/software-development-company-for-australian-clients`,
  },
  openGraph: {
    title: 'Software Development Company for Australian Clients | AITC International',
    description:
      'AITC International is a software development company serving Australian startups and businesses. Fixed-price delivery, 6+ hours AEST overlap, Australian Privacy Act compliance, and 70% cost savings vs Sydney/Melbourne rates.',
    url: `${process.env.NEXT_PUBLIC_CLIENT_URL || 'https://aitc.ai/'}location/software-development-company-for-australian-clients`,
    type: 'website',
...
export default function SoftwareDevelopmentAustraliaPage() {
  return (
    <>
      ...
      <CardGrid
        badge='Why Australian businesses choose AITC'
        heading='Engineering quality without the Sydney price tag.'
        description='Australian startups and companies choose AITC because we solve the three problems that kill most offshore relationships: timezone gaps, communication friction, and unpredictable delivery.'
        cards={whyCards}
        bg='white'
      />

      {/* What we build for Australian clients */}
      <section className='bg-gray-50'>
        <div className='common-padding mx-auto max-w-7xl py-16 md:py-20'>
          <div className='mb-10'>
            ...
            <h2 className='mt-2 text-2xl font-bold sm:text-3xl'>Full-service software development for Australian businesses</h2>
            <p className='mt-2 max-w-xl text-base text-gray-500'>
              From a focused MVP to a fully staffed product squad — we cover every stage of software development for Australian clients on your timezone.
            </p>
          </div>
      ...
      <ComparisonTable
        ...
        heading='AITC vs Australian Agency vs Freelancer'
        subheading='Why Australian businesses choose AITC over the alternatives.'
        rows={comparisonRows}
        col1Label='AITC'
        col2Label='AU Agency'
      ...
      <Technologies
        heading='Every stack your Australian product needs'
      ...
      <PostReviewsCTA
        badge='Software development for Australian clients'
      ...
      <WeHelpWithService
        ...
        description='From a single hired developer to a full dedicated squad, AITC covers every model of working with Nepal-based engineering talent for Australian businesses.'
        theme='light'
        tabs={weHelpWithTabs}
      />
      ...
      <IndustrySectors
        ...
        subheading='We have shipped production software for Australian businesses across healthcare, fintech, real estate, and more.'
      ...
      <BottomCTAForm
        ...
        form={{
          preselectedService: 'Software Development Australia',
          formName: 'bofu-software-dev-australia',
