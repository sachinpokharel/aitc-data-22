...
build-prod:
	$(DOCKER_COMPOSE) build aitc_v3_userside_prod
...
run-prod:
	$(DOCKER_COMPOSE) up -d aitc_v3_userside_prod
...
stop-prod:
	$(DOCKER_COMPOSE) down aitc_v3_userside_prod
...
shell-prod:
	$(DOCKER_COMPOSE) exec aitc_v3_userside_prod sh
...
cli-prod:
	$(DOCKER) exec -it $$($(DOCKER_COMPOSE) ps -q aitc_v3_userside_prod) /bin/bash
