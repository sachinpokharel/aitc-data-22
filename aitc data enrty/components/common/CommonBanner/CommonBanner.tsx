...
import { CommonTitleH1 } from '../CommonTitle';
...
const CommonBanner = async ({ url }: IProps) => {
  ...
  return (
    <section className='flex flex-col gap-4 bg-lightShad2 xl:flex-row'>
      ...
      <span className='hidden h-full xl:block xl:w-1/2'>
        <svg width='100%' height='570' viewBox='0 0 986 597' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <defs>
