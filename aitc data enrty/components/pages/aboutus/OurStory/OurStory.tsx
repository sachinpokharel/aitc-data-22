...
const OurStory = async () => {
  const { title, description, bgImage, sectionTitle } = await fetchData<CommonResponse>('/about-us/our-story-section');

  return (
    <CommonAnimation className='ourstory common-padding mx-auto flex max-w-[1354px] flex-col items-center gap-10 py-[3.75rem] xmd:gap-[3.25rem] xmd:py-20 xl:py-[6.25rem]'>
