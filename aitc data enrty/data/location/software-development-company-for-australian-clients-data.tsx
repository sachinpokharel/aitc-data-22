...
export const heroStats = [
  { value: '70%', label: 'Cost savings vs Sydney rates' },
  { value: '48 hrs', label: 'Fixed-price proposal delivery' },
  { value: '6+', label: 'Hours daily AEST overlap' },
...
export const heroData: LocationHeroData = {
  badge: 'Nepal · AEST timezone · Fixed-price delivery',
  badgeVariant: 'primary',
  bgVariant: 'orange',
  dotColor: '#FF7500',
  heading: [
    { text: 'A Software Development Company ' },
    { text: 'Built for Australian Businesses', highlight: true },
  ],
  description:
    'AITC builds custom software, SaaS platforms, and mobile apps for Australian startups and companies. Fixed-price delivery, 6+ hours of daily AEST overlap, and engineering quality at 70% less than Sydney or Melbourne agency rates.',
  primaryCTA: {
  ...
  floatingBadges: [
    {
      ...
      bg: 'bg-secondary',
      lines: [{ text: '70% cost savings' }, { text: 'vs Sydney / Melbourne', small: true }],
    },
    {
      position: 'top-right',
      bg: 'bg-primary',
...
export const whyCards = [
  ...
  {
    title: '6+ hours of daily AEST overlap',
    desc: 'Our Nepal-based teams start at 6:00 AM NPT — 10:15 AM AEST — giving you a full collaborative morning for standups, code reviews, and real-time decisions.',
  },
  {
    title: 'Australian Privacy Act compliance',
    desc: "We've built systems aligned with Australia's Privacy Act and the Australian Privacy Principles. Data handling, storage, and access controls are built in from the architecture stage.",
  },
  {
...
export const services = [
  {
    ...
    desc: 'Bespoke web applications, internal tools, and customer-facing platforms built end-to-end by our Nepal-based engineers for Australian businesses.',
    href: '/custom-software-development',
  },
  {
    title: 'SaaS Product Development',
    desc: 'Multi-tenant SaaS platforms architected to scale — from a validated MVP to enterprise-ready product in structured fortnightly sprints.',
    href: '/services/saas-development',
  },
  {
    title: 'Mobile App Development',
    desc: 'iOS, Android, and cross-platform apps built with Flutter and React Native by dedicated mobile engineers on your AEST hours.',
  ...
  },
  {
    ...
    desc: 'Connecting your platform to the payment gateways, CRMs, ERPs, and third-party services your Australian business depends on.',
    href: '/services/api-integration',
  },
];

export const comparisonRows: ComparisonRow[] = [
  { feature: 'Monthly cost (mid-level dev)', aitc: '$2,500–$4,000 USD', col2: '$12,000–$20,000 AUD', col3: '$4,000–$8,000 AUD' },
  { feature: 'Fixed-price project option', aitc: true, col2: false, col3: false },
  { feature: 'AEST timezone overlap (6+ hrs)', aitc: true, col2: true, col3: false },
  ...
  { feature: 'Australian Privacy Act awareness', aitc: true, col2: 'Yes', col3: 'Varies' },
...
export const processSteps = [
  {
    ...
    desc: '30 minutes on AEST time to understand your product, goals, and technical requirements. We tell you honestly what we can build and how long it will take.',
  },
  {
    timing: 'Days 2–3',
  ...
  },
  {
    ...
    desc: 'Fortnightly sprints with working demos after every cycle. Direct Slack access to your team on AEST hours throughout. Steer priorities between cycles as your product evolves.',
  },
];
...
export const engagementModels: PricingTier[] = [
  {
    ...
    features: [
      ...
      'Fortnightly demos & progress reports',
  ...
  },
  {
    ...
    desc: 'A dedicated squad of Nepal-based engineers working exclusively on your product on your AEST hours.',
    features: [
      '2–6 dedicated engineers',
      '6+ hours AEST overlap daily',
  ...
  },
  {
    ...
    desc: 'Individual engineers placed directly inside your existing Australian team — your tools, your sprint, your codebase.',
    features: [
...
export const ourWork = [
  {
    ...
    desc: 'Privacy Act-compliant patient relationship management system built with Next.js and Node.js for an Australian health network.',
  ...
  },
  {
    ...
    desc: 'High-throughput transaction processing engine handling $1M+ daily volume for an Australian payments startup.',
  ...
  },
  {
    ...
    desc: 'LLM-powered support agent that reduced human ticket volume by 40% for an Australian e-commerce brand.',
    ...
    items: [
      {
        ...
        desc: 'Dedicated Nepal-based engineers on your AEST hours.',
...
export const industrySectors: IndustrySector[] = [
  {
    name: 'Healthcare',
    tagline: 'Privacy Act-compliant digital health',
...
export const faqs: FAQ[] = [
  {
    question: 'Will the team actually work Australian hours?',
    answer:
      'Yes. Our Nepal-based teams start their day at 6:00 AM NPT — 10:15 AM AEST / 11:15 AM AEDT — giving you 6+ hours of real-time overlap for standups, code reviews, and ad-hoc calls during your core working day.',
  },
  {
    question: 'How do you deliver fixed-price projects without scope creep?',
    answer:
      'We invest heavily in the discovery and scoping phase before quoting. A detailed written brief — covering user flows, architecture decisions, and acceptance criteria — is agreed before we quote a price. Changes requested after sign-off are handled through a transparent change request process with clear cost implications.',
  },
  {
    question: 'How do you handle Australian Privacy Act compliance?',
    answer:
      "We've built systems aligned with Australia's Privacy Act 1988 and the Australian Privacy Principles (APPs). Our engineering process includes data handling protocols, storage location considerations, access controls, and privacy-by-design architecture as standard for Australian clients. We can work alongside your legal or compliance team throughout delivery.",
  },
  {
    question: 'How much does it cost for Australian businesses?',
    answer:
      'Fixed-price projects start from $15,000 USD for an MVP or defined-scope build. Dedicated team and staff augmentation engagements start from $2,500 USD/month per engineer — all-in, with no recruitment fees or hidden costs. This is approximately 70% less than equivalent talent in Sydney or Melbourne.',
  },
  {
    question: 'What types of Australian companies do you work with?',
    answer:
      "We work with early-stage Australian startups building their first product, growth-stage companies scaling their platform, and established businesses modernising legacy systems. Common clients span healthtech, fintech, real estate, e-commerce, and SaaS — both pre-seed and Series A–C.",
  },
  {
    question: 'What is your development process for Australian clients?',
    answer:
      'We run fortnightly agile sprints: two-week cycles with a working demo at the end of each. Before sprints begin, we run a design and architecture sprint to align on UX flows and technical decisions. Throughout delivery, you have direct Slack access to your team on AEST hours, a shared project roadmap, and written progress updates.',
  },
  {
  ...
  {
    question: 'What tech stacks do your engineers use for Australian projects?',
    answer:
      'Our most common stacks for Australian clients: React / Next.js for frontend, Node.js and Python (Django/FastAPI) for backend, Flutter and React Native for mobile, PostgreSQL and MongoDB for data, and AWS/GCP for cloud. We also cover Laravel, Vue, Ruby on Rails, and several niche stacks.',
  },
  {
    question: 'Can we start with a small project to evaluate the relationship?',
    answer:
      "Absolutely. Many of our longest-running Australian client relationships started with a small fixed-price engagement — a proof of concept, a specific feature, or a 4-week sprint. It's the lowest-risk way to evaluate quality and collaboration before committing to an ongoing engagement.",
  },
  {
    question: 'How quickly can we get started?',
    answer:
      'Discovery calls can be booked same-day on AEST hours. Proposals are delivered within 48 hours of the call. For dedicated teams, matched engineer profiles arrive within 24 hours of sharing requirements. Most Australian clients have their team onboarded and in standups within 2 weeks of first contact.',
  },
  {
