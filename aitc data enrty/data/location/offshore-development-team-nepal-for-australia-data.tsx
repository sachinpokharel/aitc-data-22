...
export const heroStats = [
  { value: '6+', label: 'Hours AEST overlap daily' },
  { value: '70%', label: 'Cost savings vs Sydney' },
...
export const heroScheduleItems: { label: string; time: string; active: boolean }[] = [
  { label: 'Daily standup', time: '10:15 AM AEST', active: true },
  { label: 'Code review session', time: '11:00 AM AEST', active: true },
  { label: 'Sprint planning', time: '2:00 PM AEST', active: false },
];

export const heroData: LocationHeroData = {
  badge: 'Nepal · Shifted AEST hours · 200+ vetted engineers',
  badgeVariant: 'primary',
  bgVariant: 'orange',
  dotColor: '#FF7500',
  heading: [
    { text: 'Offshore Development Team in Nepal — ' },
    { text: 'built around Australian hours', highlight: true },
  ],
  description:
    'Dedicated, pre-vetted engineers who shift their day to overlap with AEST. Offshore savings without the timezone and communication problems that usually come with them.',
  primaryCTA: {
...
export const whyCards = [
  {
    title: '6+ hours of real AEST overlap',
    desc: 'Our teams shift their day to start at 6:00 AM NPT — 10:15 AM AEST — so you get a full collaborative workday, not just async messages.',
  },
  {
    title: '70% lower cost than local hiring',
    desc: 'Mid-level engineers at $2,500–$4,000/month all-in, versus $12,000–$20,000 in Sydney or Melbourne.',
  },
  {
...
export const processSteps = [
  ...
  },
  {
    ...
    desc: '3–5 pre-vetted engineers matched to your stack and assessed for AEST timezone flexibility.',
  },
  {
    timing: 'Week 1',
  ...
  },
  {
    ...
    desc: 'Your team joins your standups and sprints on Australian time, backed by a 2-week risk-free trial.',
  },
];
...
export const engagementModels: PricingTier[] = [
  {
    ...
    desc: 'One full-time engineer on your Australian hours — your tools, your sprint, your codebase.',
    features: [
      'Shifted hours aligned to AEST/AEDT',
  ...
  },
  {
    ...
    desc: 'Developers, QA, designer, and PM — a self-managing team on Australian hours.',
...
export const weHelpWithTabs: WeHelpTab[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'For Australian Clients',
        desc: 'Our full service offering tailored for Australian businesses.',
        href: '/locations/software-development-company-for-australian-clients',
      },
      {
        iconBg: 'bg-teal-100',
...
export const faqs: FAQ[] = [
  {
    ...
    answer:
      'Yes. Our teams for Australian clients start at 6:00 AM NPT — 10:15 AM AEST / 11:15 AM AEDT — giving you a full shared workday for standups, reviews, and ad-hoc calls.',
  },
  {
    question: 'How much does it cost?',
    answer:
      'Mid-level developers are $2,500–$4,000/month all-in — roughly 70% less than equivalent talent in Sydney or Melbourne, with no recruitment fees.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Teams communicate via your preferred tools — Slack, Teams, Jira, Notion, or whatever you use. You run the standups; we handle HR, payroll, and office logistics on the Nepal side.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Every engineer goes through technical screening, English communication assessment, and a timezone-flexibility check before being matched to Australian clients. You still run your own interviews and make the final call.',
  },
];
