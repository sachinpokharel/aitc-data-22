...
export const ecommerceSectors: IndustrySector[] = [
  {
    name: 'Fashion & Apparel',
    tagline: 'Size-matrix catalogs, virtual try-on, and returns management for clothing brands.',
    desc: '', useCases: [],
    href: '/services/custom-software-development',
  ...
  {
    name: 'Food & Grocery',
    tagline: 'Same-day delivery, dark store management, and recipe-to-cart experiences.',
    desc: '', useCases: [],
    href: '/services/custom-software-development',
  ...
  {
    name: 'Health & Beauty',
    tagline: 'Subscription replenishment, loyalty programs, and personalised recommendations.',
    desc: '', useCases: [],
    href: '/services/custom-software-development',
    accentColor: 'bg-purple-500', iconBg: 'bg-purple-500/15',
    icon: <svg className='size-5 text-purple-400' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={1.5}><path strokeLinecap='round' strokeLinejoin='round' d='M21 8.25c0-2.485-2.099-4.5-4.688-4.5-1.935 0-3.597 1.126-4.312 2.733-.715-1.607-2.377-2.733-4.313-2.733C5.1 3.75 3 5.765 3 8.25c0 7.22 9 12 9 12s9-4.78 9-12z' /></svg>,
  },
  {
    name: 'B2B & Wholesale',
    tagline: 'Account-based pricing, tiered discounts, and buyer portal management.',
    desc: '', useCases: [],
    href: '/services/custom-software-development',
  ...
  },
  {
    ...
    tagline: 'Seller onboarding, commission engines, and split payment infrastructure.',
    desc: '', useCases: [],
    href: '/build/build-a-marketplace-app',
  ...
  },
  {
    ...
    tagline: 'Recurring billing, churn analytics, and subscriber lifecycle management.',
    desc: '', useCases: [],
    href: '/services/saas-development',
    accentColor: 'bg-teal-500', iconBg: 'bg-teal-500/15',
    icon: <svg className='size-5 text-teal-400' fill='none' viewBox='0 0 24 24' stroke='currentColor' strokeWidth={1.5}><path strokeLinecap='round' strokeLinejoin='round' d='M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15' /></svg>,
  },
];
