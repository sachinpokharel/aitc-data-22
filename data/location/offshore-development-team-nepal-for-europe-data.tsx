...
export const heroStats = [
  { value: '5+', label: 'Hours CET overlap daily' },
  { value: '70%', label: 'Cost savings vs London' },
...
export const heroScheduleItems: { label: string; time: string; active: boolean }[] = [
  { label: 'Daily standup', time: '9:00 AM CET', active: true },
  { label: 'Code review session', time: '10:00 AM CET', active: true },
  { label: 'Sprint planning', time: '2:00 PM CET', active: false },
];

export const heroData: LocationHeroData = {
  badge: 'Nepal · Shifted European hours · 200+ vetted engineers',
  badgeVariant: 'primary',
  bgVariant: 'orange',
  dotColor: '#FF7500',
  heading: [
    { text: 'Offshore Development Team in Nepal — ' },
    { text: 'built around European business hours', highlight: true },
  ],
  description:
    'Dedicated, pre-vetted engineers who shift their day to overlap with CET and GMT. Offshore savings without the timezone and communication problems that usually come with them.',
  primaryCTA: {
...
export const whyCards = [
  {
    title: '5+ hours of real CET overlap',
    desc: 'Our teams shift their day to start at 1:15 PM NPT — 9:00 AM CET / 8:00 AM GMT — so you get a full collaborative morning, not just async messages.',
  },
  {
    title: '70% lower cost than local hiring',
    desc: 'Mid-level engineers at $2,500–$4,000/month all-in, versus £10,000–£18,000 in London or €9,000–€16,000 in Berlin or Amsterdam.',
  },
  {
...
export const processSteps = [
  ...
  },
  {
    ...
    desc: '3–5 pre-vetted engineers matched to your stack and assessed for European timezone flexibility.',
  },
  {
    timing: 'Week 1',
  ...
  },
  {
    ...
    desc: 'Your team joins your standups and sprints on European time, backed by a 2-week risk-free trial.',
  },
];
...
export const engagementModels: PricingTier[] = [
  {
    ...
    desc: 'One full-time engineer on your European hours — your tools, your sprint, your codebase.',
    features: [
      'Shifted hours aligned to CET/GMT',
  ...
  },
  {
    ...
    desc: 'Developers, QA, designer, and PM — a self-managing team on European hours.',
...
export const weHelpWithTabs: WeHelpTab[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        title: 'For European Clients',
        desc: 'Our full service offering tailored for European businesses.',
        href: '/locations/software-development-company-for-european-clients',
      },
      {
        iconBg: 'bg-teal-100',
...
export const faqs: FAQ[] = [
  {
    ...
    answer:
      'Yes. Our teams for European clients shift their day to align with CET — starting overlap at 9:00 AM CET / 8:00 AM GMT. You get a full collaborative morning for standups, reviews, and ad-hoc calls.',
  },
  {
    question: 'How much does it cost?',
    answer:
      'Mid-level developers are $2,500–$4,000/month all-in — roughly 70% less than equivalent talent in London, Berlin, or Amsterdam, with no recruitment fees, benefits overhead, or office costs.',
  },
  {
  ...
  },
  {
    ...
    answer:
      'Every engineer goes through technical screening, English communication assessment, and a timezone-flexibility check before being matched to European clients. You still run your own interviews and make the final call.',
  },
  {
    question: 'Are your engineers familiar with GDPR and European compliance standards?',
    answer:
      'Yes. Our engineers regularly work on products requiring GDPR compliance, and our team follows data handling best practices aligned with European regulations. Security and privacy-by-design are part of our standard development process.',
  },
];
